...
<div id="apDiv7"></div>
<div class="style19" id="apDiv17">SCREEN</div>
<div id="apDiv18">
  <table width="981" height="115" border="1" bordercolor="#000000">
    <tr>
      <th bgcolor="#999999" scope="col">scId</th>
      <th bgcolor="#999999" scope="col">scName</th>
      <th bgcolor="#999999" scope="col">scPicture</th>
      <th bgcolor="#999999" scope="col">scIsactive</th>
    </tr>
        <?php
