...
<div id="apDiv17">
  <table width="1145" height="157" border="1" bgcolor="#800040">
    <tr>
...
?>
    ...
    <tr>
      ...
      <td>   
<a href="movie_action.php?mId=<?php echo $row['mId'] ?>"><img src="<?php echo $row['mBanner'] ?>"  height="150" width="150" ></a></td>
...
<div class="style20" id="apDiv18">MOVIE DETAILS</div>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <p class="style11">&nbsp;</p>
  <p>&nbsp;</p>
