...
<div id="apDiv11">
  <table width="255" border="0">
    <tr>
      ...
      <td width="124" bordercolor="#000000" bgcolor="#000000"><a href="tcontact.php" class="style7">CONTACT US</a></td>
    </tr>
  </table>
</div>
...
<div id="apDiv5">
  <table width="1001" height="50" border="0" bordercolor="#000000">
    <tr>
      <td width="38" height="44" bordercolor="#000000"><form id="form1" name="form1" method="post" action="">
        <label>
...
<div id="apDiv9"><img src="food1.jpg" width="982" height="483" /></div>
sss
<div id="apDiv">
  <table width="1049" height="108" border="0">
    <tr>
      <td width="317"><form id="form2" name="form4" method="post" action="">
        <label>
          <input type="image" name="imageField2" id="imageField2" src="fb_23.jpg" />
          </label>
      </form></td>
      <td width="326"><form id="form3" name="form5" method="post" action="">
        <label>
          <input type="image" name="imageField2" id="imageField3" src="fb_13_3.jpg" />
          </label>
      </form></td>
      <td width="402"><form id="form7" name="form6" method="post" action="">
        <label>
          <input type="image" name="imageField2" id="imageField7" src="popcorn_3105.jpg" />
          </label>
      </form></td>
    </tr>
  </table>
